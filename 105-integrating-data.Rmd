...
srun -p high -t 14:00:00 --mem=16G --nodes=1 $HOME/angsd/angsd -P 8 \
  ...
  -r lg01 \
   -minInd 144 \
  -out $HOME/longfin/outputs/105-beagle > outputs/105/beagle-contigs.out 2> outputs/105/beagle-contigs.err &
```
...
```{sh, eval=FALSE}
python $HOME/pcangsd/pcangsd.py -beagle outputs/105-beagle.beagle.gz \
   -admix -o outputs/105/192-pca -threads 10
```
...
Now to remove non-longfin from data